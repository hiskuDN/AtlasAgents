...
class MockPlannerAgent(BaseAgent):
    """Mock planner agent that returns a predefined plan."""
...
class MockSpecWriterAgent(BaseAgent):
    """Mock spec writer agent that returns predefined specifications."""
...
class MockCoderAgent(BaseAgent):
    """Mock coder agent that returns code changes."""
...
class MockReviewerAgent(BaseAgent):
    """Mock reviewer agent that provides code review."""
